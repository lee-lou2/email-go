...
`email-go`는 대량 이메일 발송을 위한 고성능 시스템입니다. AWS SQS, SES, SNS를 활용하여 안정적인 이메일 발송과 결과 추적을 제공합니다. 특히 최소한의 리소스로 최대의 성능을 발휘하도록 설계되었습니다.
...
### 이메일 오픈 추적
```http
GET /v1/events/open?messageId={메시지ID}
Response: 1x1 투명 픽셀
```
